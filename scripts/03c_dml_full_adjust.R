...
# Model: treatment + sex + ga + BMI_child
...
write.table(getData(myDiff25p), file = file.path(output_dir, "myDiff25p_full_adjust.txt"), sep = "\t", quote = FALSE)

# Visualize the distribution of hypo/hyper-methylated bases/regions per chromosome.
pdf(file.path(output_dir, "diffMethPerChr_full_adjust.pdf"), h = 10, w = 16)
